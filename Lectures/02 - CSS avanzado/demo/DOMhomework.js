...
function buildToDo(todo, index) {
  ...
  //  <span> Agrego mi tarea </span></span>
  // consigna 5

  toDoText.setAttribute("id", index);
  //<span id="1" > Agrego mi tarea </span></span>

  //---------- consigna 3 del ultimo ejercicio
  ...
  if (todo.complete) {
    // {description: Algo por hacer , complete:true}
    toDoText.setAttribute("class", "completeText");
    // <span id="1" class="completeText"> Agrego mi tarea </span></span>
  }
...
function displayToDos() {
  ...
  // result = [<div ><span >Hacer la Homework del DOM</span></div>,<div ><span >NO poder con la HW tirarme al piso y llorar</span></div>]
...
function addToDo() {
  ...
  let tarea = new ToDo(descripcion); // {description: Algo por hacer , complete:false}
